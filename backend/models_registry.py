...
REGISTRY: dict[str, ModelEntry] = {
    ...
    # Animate a still image into a short clip. All 11 vendor schemas
    # checked: every one uses singular "image" (string URL), not an array.
    # The dispatcher branches on task=="i2v" + atlas_image_field to send
    # the right body shape.

    # SFW
    "atlas-happyhorse-1-i2v": ModelEntry(
        slug="atlas-happyhorse-1-i2v",
        label="HappyHorse 1.0 (Atlas)",
        description="Alibaba's HappyHorse image-to-video. Animate a first-frame image into 3-15 second clips at 720P or 1080P with optional prompt guidance.",
        provider="atlas",
        atlas_model_id="alibaba/happyhorse-1.0/image-to-video",
    ...
    "atlas-veo-3-1-i2v": ModelEntry(
        slug="atlas-veo-3-1-i2v",
        label="Veo 3.1 (Atlas)",
        description="Google's Veo 3.1 image-to-video with synchronized audio. Flagship quality, highest price tier.",
        provider="atlas",
        atlas_model_id="google/veo3.1/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
    ...
    "atlas-seedance-2-i2v": ModelEntry(
        slug="atlas-seedance-2-i2v",
        label="Seedance 2.0 (Atlas)",
        description="ByteDance's Seedance 2.0 image-to-video. First-frame animation with native audio support, optional last-frame guidance.",
        provider="atlas",
        atlas_model_id="bytedance/seedance-2.0/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        nsfw=False,
        speed="medium",
        best_for="general i2v + audio",
        price_per_image_usd=0.096,
        max_ref_images=1,
        provider_label="ByteDance · Atlas",
    ),
    "atlas-kling-v3-std-i2v": ModelEntry(
        slug="atlas-kling-v3-std-i2v",
        label="Kling 3.0 Std (Atlas)",
        description="Kuaishou's Kling 3.0 Standard image-to-video. Strong cinematic motion + identity consistency, mid-range price.",
        provider="atlas",
        atlas_model_id="kwaivgi/kling-v3.0-std/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        nsfw=False,
        speed="medium",
        best_for="cinematic motion",
        price_per_image_usd=0.071,
        max_ref_images=1,
        provider_label="Kuaishou · Atlas",
    ),
    "atlas-vidu-q3-pro-i2v": ModelEntry(
        slug="atlas-vidu-q3-pro-i2v",
        label="Vidu Q3 Pro (Atlas)",
        description="Vidu Q3-Pro image-to-video. Reasonable quality at half the price of Kling Std. Good as a cheap second-opinion render.",
        provider="atlas",
        atlas_model_id="vidu/q3-pro/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        nsfw=False,
        speed="medium",
        best_for="budget alternative",
        price_per_image_usd=0.042,
        max_ref_images=1,
        provider_label="Vidu · Atlas",
    ),

    # NSFW / spicy
    "atlas-seedance-v15-spicy-i2v": ModelEntry(
        slug="atlas-seedance-v15-spicy-i2v",
        label="Seedance v1.5 Spicy (Atlas)",
        description="ByteDance Seedance v1.5 Pro Spicy. Same Seedance engine with content-moderation relaxed for NSFW work. Image field is optional on this variant.",
        provider="atlas",
        atlas_model_id="bytedance/seedance-v1.5-pro/image-to-video-spicy",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        speed="medium",
        best_for="NSFW i2v",
        price_per_image_usd=0.049,
        max_ref_images=1,
        provider_label="ByteDance · Atlas",
    ),
    "atlas-wan-2-6-spicy-i2v": ModelEntry(
        slug="atlas-wan-2-6-spicy-i2v",
        label="Wan 2.6 Spicy (Atlas)",
        description="Atlas-hosted Wan 2.6 Spicy. Balanced default for NSFW i2v -- broader prompt acceptance than vanilla Wan 2.6 at the same price.",
        provider="atlas",
        atlas_model_id="atlascloud/wan-2.6-spicy/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        nsfw=True,
        speed="medium",
        best_for="strong balanced NSFW default",
        price_per_image_usd=0.070,
        max_ref_images=1,
        provider_label="Atlas · Spicy",
    ),
    "atlas-wan-2-7-i2v": ModelEntry(
        slug="atlas-wan-2-7-i2v",
        label="Wan 2.7 (Atlas)",
        description="Alibaba's Wan 2.7 image-to-video. First-frame, first-and-last-frame, video continuation, and audio-driven modes. NSFW-permissive at Atlas.",
        provider="atlas",
        atlas_model_id="alibaba/wan-2.7/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        nsfw=True,
        speed="medium",
        best_for="multi-mode i2v",
        price_per_image_usd=0.100,
        max_ref_images=1,
        provider_label="Alibaba · Atlas",
    ),
    "atlas-wan-2-2-turbo-spicy-infinite-i2v": ModelEntry(
        slug="atlas-wan-2-2-turbo-spicy-infinite-i2v",
        label="Wan 2.2 Turbo Spicy Infinite (Atlas)",
        description="Long-form NSFW i2v. Segmented-prompt 'infinite' variant of Wan 2.2 turbo spicy with stable motion and 30fps workflow post-processing. Best cost/long-form option.",
        provider="atlas",
        atlas_model_id="atlascloud/wan-2.2-turbo-spicy/infinite-image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        nsfw=True,
        speed="fast",
        best_for="cheap long-form NSFW",
        price_per_image_usd=0.020,
        max_ref_images=1,
        provider_label="Atlas · Spicy",
    ),
    "atlas-wan-2-2-spicy-i2v": ModelEntry(
        slug="atlas-wan-2-2-spicy-i2v",
        label="Wan 2.2 Spicy (Atlas)",
        description="Alibaba's Wan 2.2 Spicy i2v. Open-source Wan 2.2 weights with NSFW-friendly moderation. Cheaper than Wan 2.6 Spicy; older but well-supported.",
        provider="atlas",
        atlas_model_id="alibaba/wan-2.2-spicy/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
        ...
        nsfw=True,
        speed="medium",
        best_for="open-source NSFW",
        price_per_image_usd=0.030,
        max_ref_images=1,
        provider_label="Alibaba · Atlas",
    ),
    "atlas-wan-2-2-turbo-spicy-i2v": ModelEntry(
        slug="atlas-wan-2-2-turbo-spicy-i2v",
        label="Wan 2.2 Turbo Spicy (Atlas)",
        description="Wan 2.2 with rCM turbo acceleration + spicy moderation. Cheapest NSFW option at \\$0.02/output; quality below Spicy non-turbo but fast enough for draft work.",
        provider="atlas",
        atlas_model_id="atlascloud/wan-2.2-turbo-spicy/image-to-video",
        atlas_image_field="image",
        output_kind="video",
        accepts_image=True,
        stage=1,
