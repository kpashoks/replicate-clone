...
# task value.
Task = Literal["t2i", "i2i", "video-swap", "t2v"]
...
REGISTRY: dict[str, ModelEntry] = {
    ...
    # ---- Atlas Cloud: text-to-video --------------------------------------
    # All hosted, no Pod lifecycle. Pay per output. SFW/permissive by
    # vendor policy; some vendors content-moderate. Sora 2 is NOT yet on
    # Atlas (OpenAI-direct only); kept as a coming-soon placeholder so it
    # shows in the picker but can't be selected.
    "atlas-seedance-2-t2v": ModelEntry(
        slug="atlas-seedance-2-t2v",
        label="Seedance 2.0 (Atlas)",
        description="ByteDance's Seedance 2.0 text-to-video. Native audio generation, optional web search grounding, strong prompt fidelity.",
        provider="atlas",
        atlas_model_id="bytedance/seedance-2.0/text-to-video",
        output_kind="video",
        stage=1,
        available=True,
        task="t2v",
        nsfw=False,
        speed="medium",
        best_for="general T2V + audio",
        price_per_image_usd=0.096,
        provider_label="ByteDance · Atlas",
    ),
    "atlas-seedance-v15-pro-t2v": ModelEntry(
        slug="atlas-seedance-v15-pro-t2v",
        label="Seedance v1.5 Pro (Atlas)",
        description="Older Seedance Pro tier. Cheaper than 2.0 at half the price, slightly different aesthetic. Useful for batch / drafts.",
        provider="atlas",
        atlas_model_id="bytedance/seedance-v1.5-pro/text-to-video",
        output_kind="video",
        stage=1,
        available=True,
        task="t2v",
        nsfw=False,
        speed="fast",
        best_for="cheap / batch",
        price_per_image_usd=0.047,
        provider_label="ByteDance · Atlas",
    ),
    "atlas-happyhorse-1-t2v": ModelEntry(
        slug="atlas-happyhorse-1-t2v",
        label="HappyHorse 1.0 (Atlas)",
        description="Alibaba's HappyHorse text-to-video. 720P or 1080P output, 3-15 second durations with optional prompt guidance.",
        provider="atlas",
        atlas_model_id="alibaba/happyhorse-1.0/text-to-video",
        output_kind="video",
        stage=1,
        available=True,
        task="t2v",
        nsfw=False,
        speed="medium",
        best_for="long clips (up to 15s)",
        price_per_image_usd=0.140,
        provider_label="Alibaba · Atlas",
    ),
    "atlas-kling-v3-pro-t2v": ModelEntry(
        slug="atlas-kling-v3-pro-t2v",
        label="Kling 3.0 Pro (Atlas)",
        description="Kuaishou's Kling 3.0 Professional. Premium quality with advanced features. Strong cinematic motion + identity consistency.",
        provider="atlas",
        atlas_model_id="kwaivgi/kling-v3.0-pro/text-to-video",
        output_kind="video",
        stage=1,
        available=True,
        task="t2v",
        nsfw=False,
        speed="medium",
        best_for="cinematic / premium",
        price_per_image_usd=0.095,
        provider_label="Kuaishou · Atlas",
    ),
    "atlas-veo-3-1-t2v": ModelEntry(
        slug="atlas-veo-3-1-t2v",
        label="Veo 3.1 (Atlas)",
        description="Google's Veo 3.1 flagship text-to-video. Native synchronized audio, highest tier. Most expensive option but best for showpiece work.",
        provider="atlas",
        atlas_model_id="google/veo3.1/text-to-video",
        output_kind="video",
        stage=1,
        available=True,
        task="t2v",
        nsfw=False,
        speed="medium",
        best_for="flagship / showpiece",
        price_per_image_usd=0.200,
        provider_label="Google · Atlas",
    ),
    "atlas-wan-2-7-t2v": ModelEntry(
        slug="atlas-wan-2-7-t2v",
        label="Wan 2.7 (Atlas)",
        description="Alibaba's Wan 2.7 text-to-video. Multi-shot narrative support, audio generation, sound-image synchronization. Good open-source alternative.",
        provider="atlas",
        atlas_model_id="alibaba/wan-2.7/text-to-video",
        output_kind="video",
        stage=1,
        available=True,
        task="t2v",
        nsfw=True,
        speed="medium",
        best_for="multi-shot narrative",
        price_per_image_usd=0.100,
        provider_label="Alibaba · Atlas",
    ),
    "atlas-wan-2-6-t2v": ModelEntry(
        slug="atlas-wan-2-6-t2v",
        label="Wan 2.6 (Atlas)",
        description="Alibaba's Wan 2.6 text-to-video. Older sibling of Wan 2.7 at 30% lower price. Useful for batch / drafts.",
        provider="atlas",
        atlas_model_id="alibaba/wan-2.6/text-to-video",
        output_kind="video",
        stage=1,
        available=True,
        task="t2v",
        ...
        speed="medium",
        best_for="cheap Wan",
        price_per_image_usd=0.070,
        provider_label="Alibaba · Atlas",
    ),
    "atlas-sora-2-t2v": ModelEntry(
        slug="atlas-sora-2-t2v",
        label="OpenAI Sora 2 (Coming soon)",
        description="OpenAI's Sora 2 text-to-video. Currently OpenAI-direct only (waitlist); no aggregator hosts it yet. This entry is a placeholder -- enable once Atlas adds it to their catalog.",
        provider="atlas",
        atlas_model_id="openai/sora-2/text-to-video",
        output_kind="video",
        stage=2,
        available=False,
        task="t2v",
        nsfw=False,
        speed="medium",
        best_for="OpenAI quality (when available)",
        price_per_image_usd=None,
